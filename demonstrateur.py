...
out = cv2.VideoWriter('videos/output_video.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 25, (int(cap.get(cv2.CAP_PROP_FRAME_WIDTH)), int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))))
...
while True:
    ...
    if faces.multi_face_landmarks:
        ...
        if key == 27 or key == ord('q'):
            ...
            plt.ylabel("PERCLOS")
            plt.savefig('graphics/PERCLOS.png')
            plt.ylim(0,30)
